...
// pagination
$jumlahData = count(query("SELECT * FROM buletin WHERE kategori = 'buletin'"));
...
$info = query("SELECT * FROM buletin WHERE kategori = 'buletin' ORDER BY id DESC LIMIT $awalData, 10");
?>
