...
$result = mysqli_query($conn, "SELECT * FROM waktu ORDER BY id DESC LIMIT 1");
                ...
                <main id="main">
                    ...
                    <div class="container">
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    <th rowspan="2" style=" align-items: center;"></th>
                                    <th colspan="2" style="text-align: center;">29/05/2023</th>
                                    <th colspan="2" style="text-align: center;">30/05/2023</th>
                                    <th colspan="2" style="text-align: center;">31/05/2023</th>
                                    <th colspan="2" style="text-align: center;">01/06/2023</th>
                                    <th colspan="2" style="text-align: center;">02/06/2023</th>


                                </tr>
                                <tr>
                                    <th scope="col">Terbit</th>
                                    <th scope="col">Terbenam</th>
                                    <th scope="col">Terbit</th>
                                    <th scope="col">Terbenam</th>
                                    <th scope="col">Terbit</th>
                                    <th scope="col">Terbenam</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row">Kabupaten Bima</th>
                                    <td>06:20</td>
                                    <td>18:00</td>
                                    <td>06:20</td>
                                    <td>18:00</td>
                                ...
                                <tr>
                                    <th scope="row">Kabupaten Dompu</th>
                                    <td>06:20</td>
                                    <td>18:00</td>
                                    <td>06:20</td>
                                    <td>18:00</td>
