...
// pagination
$jumlahData = count(query("SELECT * FROM buletin WHERE kategori = 'majalah'"));
...
$info = query("SELECT * FROM buletin WHERE kategori = 'majalah' ORDER BY id DESC LIMIT $awalData, 10");
?>
                    ...
                    <?php foreach ($info as $row) : ?>
                        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                            <div class="portfolio-wrap">
                                <img src="img/<?= $row["gambar"]; ?>" class="img-fluid" alt="" style="height: 400px; width:400px">
                                <div class="portfolio-links">
                                    <a title="donwload" href="donwloadFile.php?buletin=<?= $row['buletin']; ?>"><i class="bi bi-arrow-down"></i></a>
                                </div>
