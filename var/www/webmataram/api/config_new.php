...
define('DB_USER', 'bmkg_user'); // Sesuaikan dengan username database Anda
define('DB_PASS', 'bmkg_pass_2024'); // Sesuaikan dengan password database Anda
...
// Helper function for mysqli connection (used by manage_categories.php and manage_news.php)
...
// Database Connection Class (for PDO)
class Database {
